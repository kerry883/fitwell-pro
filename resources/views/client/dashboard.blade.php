        ...
        <div class="relative">
            <div class="md:flex md:items-center md:justify-between">
                ...
                <div class="mt-6 flex flex-col space-y-3 md:ml-6 md:mt-0 md:flex-row md:space-x-3 md:space-y-0">
                    <a href="{{ route('client.programs.index') }}" class="group inline-flex items-center justify-center rounded-xl bg-white/20 px-6 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/30 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/50">
        ...
        <div class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 overflow-hidden">
            <div class="bg-gradient-to-r from-emerald-50 to-cyan-50 px-6 py-4 border-b border-emerald-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('client.programs.index') }}" class="text-sm font-medium text-emerald-600 hover:text-emerald-500 transition-colors">
                        View all →
                    </a>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="group relative overflow-hidden rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 p-4 transition-all duration-300 hover:from-emerald-50 hover:to-cyan-50 hover:shadow-md
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                @if($program->price)
                                    <p class="text-sm font-semibold text-gray-900">{{ $program->getFormattedPrice() }}</p>
                                @else
                                    <p class="text-sm font-semibold text-emerald-600">Free</p>
                                @endif
                                <a href="{{ route('client.programs.show', $program->id) }}" class="text-xs text-emerald-600 hover:text-emerald-500 font-medium transition-colors">
                                    View Details →
                                </a>
                            </div>
                        </div>
        ...
        <div class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 overflow-hidden">
            <div class="bg-gradient-to-r from-orange-50 to-red-50 px-6 py-4 border-b border-orange-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('client.workouts.index') }}" class="text-sm font-medium text-orange-600 hover:text-orange-500 transition-colors">
                        View all →
                    </a>
                </div>
            </div>
