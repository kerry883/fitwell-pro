                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="duration_weeks" name="duration_weeks"
                                        value="{{ $program['duration_weeks'] }}" min="1" max="52" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="difficulty_level" name="difficulty_level" required>
                                        <option value="beginner"
                                            {{ $program['difficulty_level'] === 'beginner' ? 'selected' : '' }}>Beginner
                                        </option>
                                        <option value="intermediate"
                                            {{ $program['difficulty_level'] === 'intermediate' ? 'selected' : '' }}>
                                            Intermediate</option>
                                        <option value="advanced"
                                            {{ $program['difficulty_level'] === 'advanced' ? 'selected' : '' }}>Advanced
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="program_type" name="program_type" required>
                                        <option value="strength_training"
                                            {{ $program['program_type'] === 'strength_training' ? 'selected' : '' }}>
                                            Strength Training</option>
                                        <option value="cardio"
                                            {{ $program['program_type'] === 'cardio' ? 'selected' : '' }}>Cardio</option>
                                        <option value="flexibility"
                                            {{ $program['program_type'] === 'flexibility' ? 'selected' : '' }}>Flexibility
                                        </option>
                                        <option value="weight_loss"
                                            {{ $program['program_type'] === 'weight_loss' ? 'selected' : '' }}>Weight Loss
                                        </option>
                                        <option value="muscle_building"
                                            {{ $program['program_type'] === 'muscle_building' ? 'selected' : '' }}>Muscle
                                            Building</option>
                                        <option value="sports_specific"
                                            {{ $program['program_type'] === 'sports_specific' ? 'selected' : '' }}>Sports
                                            Specific</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="sessions_per_week" name="sessions_per_week" required>
                                        <option value="1" {{ $program['sessions_per_week'] == 1 ? 'selected' : '' }}>1
                                        </option>
                                        <option value="2" {{ $program['sessions_per_week'] == 2 ? 'selected' : '' }}>2
                                        </option>
                                        <option value="3" {{ $program['sessions_per_week'] == 3 ? 'selected' : '' }}>3
                                        </option>
                                        <option value="4" {{ $program['sessions_per_week'] == 4 ? 'selected' : '' }}>4
                                        </option>
                                        <option value="5" {{ $program['sessions_per_week'] == 5 ? 'selected' : '' }}>5
                                        </option>
                                        <option value="6" {{ $program['sessions_per_week'] == 6 ? 'selected' : '' }}>6
                                        </option>
                                        <option value="7" {{ $program['sessions_per_week'] == 7 ? 'selected' : '' }}>7
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="draft" {{ $program['status'] === 'draft' ? 'selected' : '' }}>Draft
                                        </option>
                                        <option value="published"
                                            {{ $program['status'] === 'published' ? 'selected' : '' }}>Published</option>
                                        <option value="archived" {{ $program['status'] === 'archived' ? 'selected' : '' }}>
                                            Archived</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="equipment_needed"
                                            name="equipment_needed" value="1"
                                            {{ $program['equipment_needed'] ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_public" name="is_public"
                                            value="1" {{ $program['is_public'] ?? false ? 'checked' : '' }}>
                                        ...
                                        <div class="objective-item mb-2">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="objectives[]"
                                                    value="{{ $objective }}" placeholder="Program objective">
                                        ...
                                        <div class="workout-item card mb-3">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h6>{{ $workout['title'] }}</h6>
                                                        <p class="text-muted mb-2">Week {{ $workout['week'] }}, Day
                                                            {{ $workout['day'] }} • {{ $workout['duration'] ?? 60 }}
                                                            minutes</p>
                                                        <div class="d-flex gap-2">
                                                            @foreach ($workout['focus_areas'] ?? [] as $area)
                                                                <span
                                                                    class="badge bg-light text-dark">{{ $area }}</span>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="#"
                                                                    onclick="editWorkout({{ json_encode($workout) }})">Edit</a>
                                                            </li>
                                                            <li><a class="dropdown-item text-danger" href="#"
                                                                    onclick="removeWorkout(this)">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="program-preview">
                                    ...
                                    <div class="col-4">
                                        <div class="preview-stat">
                                            <span id="preview-difficulty"
                                                class="badge bg-secondary">{{ ucfirst($program['difficulty_level']) }}</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <span id="preview-type"
                                        class="ms-2">{{ ucfirst(str_replace('_', ' ', $program['program_type'])) }}</span>
                                </div>

                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-muted">Equipment:</span>
                                    <span
                                        id="preview-equipment">{{ $program['equipment_needed'] ? 'Required' : 'Not Required' }}</span>
                                </div>
                            </div>
                        </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('difficulty_level').addEventListener('change', function() {
                ...
                badge.className = 'badge bg-' + (this.value === 'beginner' ? 'success' : this.value === 'intermediate' ?
                    'warning' : 'danger');
            });

            document.getElementById('program_type').addEventListener('change', function() {
                document.getElementById('preview-type').textContent = this.value.replace('_', ' ').replace(/\b\w/g, l =>
                    l.toUpperCase());
            });
