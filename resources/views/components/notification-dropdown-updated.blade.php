<div class="relative" x-data="notificationDropdown" x-init="loadNotifications(); listenForNotifications();">
    <!-- Notification Button -->
    <button type="button"
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center"
                                ...
                                <svg x-show="notification.type === 'assignment_rejected'" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                </svg>
